...
class NatsJetStreamPullConsumerIT extends NatsJetStreamITSupport {

    private static final String BODY = "NATS JetStream Pull - Hello, World!", OPTIONS_TYPE
            = "pullSubscribeOptions", OPTIONS_NAME = "testOptions", SUBJECT_NAME = "pull.test";

    NatsJetStreamPullConsumerIT() {
        super(SUBJECT_NAME);
    }

    @EndpointInject("mock:pullResult")
    ...
    protected void bindToRegistry(Registry registry) {
        final PullSubscribeOptions.Builder options = PullSubscribeOptions.builder()
